            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-gray-300 hover:text-white transition">Investment Opportunities</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition">Stock Information</a></li>
                    </ul>
                </div>

                <!-- Column 5: NEWS & INSIGHT -->
                <div>
                    <h3 class="text-lg font-bold mb-4 text-green-400">NEWS & INSIGHT</h3>
                    <ul class="space-y-2">
                        <li><a href="#" class="text-gray-300 hover:text-white transition">Research Article</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition">Case Study</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition">Financial Education Content</a></li>
                    </ul>
                </div>
